<!--Final Year Web-Based Project: riversdale.php/(Release) Coded by ara16-->
<?php
session_start();
$userLoggedIn = True;
?>
...
<html lang ="en">
	...
	<body>
		...
		<div class="demobox">
			...
			<p class="riversdale-info"><br>Ceredigion lies along the edge of the sea, a seeming dead end, but the Riversdale reminds us of our locality's international connections
